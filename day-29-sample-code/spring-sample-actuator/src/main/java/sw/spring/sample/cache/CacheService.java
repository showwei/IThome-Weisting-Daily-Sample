...
import sw.spring.sample.models.APITriggerModel;
...
public class CacheService {
    ...
    public static final Cache<String, APITriggerModel> SEA_FOOD_API_MONITOR_CACHE =  CacheBuilder.newBuilder().expireAfterWrite(1, TimeUnit.DAYS).build();;
